...
import type {BufferContent, RemGLKMessage} from "./types.ts";
...
(async () => {
    ...
    await client(story.href, type as SupportedGameType);
    ...
    window.addEventListener('message', message => {
        ...
        const update = message.data as RemGLKMessage;
        const html = render(update);
        document.body.append(fragment(html))
    })
})();

export function render(update: RemGLKMessage): string {
